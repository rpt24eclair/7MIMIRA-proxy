...
app.get('/bundles', (req, res) => {
  async function retrieveBundles() {
    try {
      ...
      let reviewsComponent = await axios.get(`http://localhost:3003/bundle.js`);
...
app.get('/shoes/:shoeId/reviews/:count', (req, res) => {
  ...
  axios.get(`http://localhost:3003/shoes/${shoeId}/reviews`)
  .then(reviews => {
...
app.get('/shoes/:shoeId/rating', (req, res) => {
  let { shoeId } = req.params;
  axios.get(`http://localhost:3003/shoes/${shoeId}/rating`)
  .then(rating => {
